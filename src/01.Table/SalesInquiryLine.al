table 50000 "Sales Inquiry Line"
{
    ...
    fields
    {
        ...
        field(100; "Job Queue Status"; Option)
        ...
        { }
        field(114; "Shipping Advice"; Option)
        ...
        { }
        field(132; "VAT Rounding Type"; Option)
        { OptionMembers = Nearest,Up,Down; }
        field(133; "VAT Calc. per Line"; Boolean)
        { }
        field(134; "Bank Account No."; Code[20])
        { }
        field(135; "Invoice Type"; Option)
        { OptionMembers = ,Sales,Receipt; }
        field(136; "For Collective Invoice"; Boolean)
        { }
        field(137; "Collective Invoice Code"; Option)
        { OptionMembers = ,Free,"5th","10th","15th","20th","25th","End of Month"; }
        ...
        { }
        field(212; "IC Partner Ref. Type"; Option)
        ...
        { }
        field(221; "Prepmt. VAT Calc. Type"; Option)
        { OptionMembers = "Normal VAT","Reverse Charge VAT","Full VAT","Sales Tax"; }
        ...
        { }
        field(268; "Cross-Reference Type"; Option)
